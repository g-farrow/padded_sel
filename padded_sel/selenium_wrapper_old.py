...
def goto(testData, URL, direct=False, timeout=False):  # to be used for normal testing
    ...
    if direct == False:
        setURL = testData['driver_url'] + URL
    else:
        setURL = URL
...
def sendKeysByID(testData, elementID, text):
    ...
    try:
        ...
        logger.info(
            "Element id '%s' was not cleared, this could be because it is not a standard text field" % elementID)
    try:
...
def sendKeysByCSS(testData, css_selector, text):
    ...
    try:
        ...
        logger.info(
            "Element css_selector '%s' was not cleared, this could be because it is not a standard text field" % css_selector)
    try:
...
def waitForAttributeByXPath(testData, xpath, attribute, value, timeToWait=waitForTime):
    ...
    for i in range(int(timeToWait)):
        try:
            ...
            pass
        time.sleep(1)
    logger.failed("Value '%s' was not found in xpath '%s', attribute '%s' after '%s' seconds" % (
    value, xpath, attribute, str(timeToWait)))
    actionsOnFail.performActions(testData)
    return "FAILED"
...
def waitForAttributeByID(testData, elementID, attribute, value, timeToWait=waitForTime):
    ...
    for i in range(int(timeToWait)):
        try:
            ...
            pass
        time.sleep(1)
    logger.failed("Value '%s' was not found in elementID '%s', attribute '%s' after '%s' seconds" % (
    value, elementID, attribute, str(timeToWait)))
    actionsOnFail.performActions(testData)
    return "FAILED"
    ...
    for i in range(int(timeToWait)):
        try:
            if value in driver.find_element_by_css_selector(css_selector).get_attribute(attribute):
                logger.passed(
                    "Value '%s' was found in css_selector '%s', attribute '%s'" % (value, css_selector, attribute))
                return "PASSED"
        except:
            pass
        time.sleep(1)
    logger.failed("Value '%s' was not found in css_selector '%s', attribute '%s' after '%s' seconds" % (
    value, css_selector, attribute, str(timeToWait)))
    actionsOnFail.performActions(testData)
    return "FAILED"
...
def waitForAttributeByName(testData, name, attribute, value, timeToWait=waitForTime):
    ...
    for i in range(int(timeToWait)):
        try:
            ...
            pass
        time.sleep(1)
    logger.failed("Value '%s' was not found in name '%s', attribute '%s' after '%s' seconds" % (
    value, name, attribute, str(timeToWait)))
    actionsOnFail.performActions(testData)
    return "FAILED"
...
def waitForValueByCSS(testData, css_selector, value, timeToWait=waitForTime):
    ...
    for i in range(int(timeToWait)):
        ...
        time.sleep(1)
    logger.failed(
        "Value '%s' was not found in element '%s' after '%s' seconds" % (value, css_selector, str(timeToWait)))
    actionsOnFail.performActions(testData)
    return "FAILED"
    ...
    try:
        ...
        while attempt <= retry:
            ...
            try:
                driver.find_element_by_id(elementID).is_displayed()
                logger.passed(
                    "elementID '%s' is now visible after scrolling a total of '%s' pixels" % (elementID, totalScroll))
                return "PASSED"
            except:
                pass
            attempt += 1
    logger.failed(
        "After scrolling down '%s' pixels, the elementID '%s' was still not visible" % (totalScroll, elementID))
    ...
    try:
        ...
        while attempt <= retry:
            ...
            try:
                driver.find_element_by_xpath(name).is_displayed()
                logger.passed(
                    "Element xpath '%s' is now visible after scrolling a total of '%s' pixels" % (name, totalScroll))
                return "PASSED"
            except:
                pass
            attempt += 1
    logger.failed(
        "After scrolling down '%s' pixels, the element xpath '%s' was still not visible" % (totalScroll, name))
    ...
    try:
        ...
        while attempt <= retry:
            ...
            try:
                driver.find_element_by_xpath(xpath).is_displayed()
                logger.passed(
                    "Element xpath '%s' is now visible after scrolling a total of '%s' pixels" % (xpath, totalScroll))
                return "PASSED"
            except:
                pass
            attempt += 1
    logger.failed(
        "After scrolling down '%s' pixels, the element xpath '%s' was still not visible" % (totalScroll, xpath))
...
def scrollToElementByCSS(testData, css_selector):
    ...
    try:
		...
		while attempt <= retry:
            ...
            try:
                driver.find_element_by_xpath(css_selector).is_displayed()
                logger.passed("Element xpath '%s' is now visible after scrolling a total of '%s' pixels" % (
                css_selector, totalScroll))
                return "PASSED"
            except:
                pass
            attempt += 1
    logger.failed(
        "After scrolling down '%s' pixels, the element xpath '%s' was still not visible" % (totalScroll, css_selector))
...
def storeAttributeByXPath(testData, xpath, attribute, variableName):
    ...
    try:
        ...
        logger.error(str(e))
        actionsOnFail.performActions(testData)
        testData[variableName] = "There was an ERROR trying to store attribute '%s' from xpath '%s' here" % (
        attribute, xpath)
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_xpath(xpath).get_attribute(attribute)
        logger.data("Attribute '%s' (found at xpath '%s') = '%s' (stored as '%s' in testData)" % (
        attribute, xpath, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeAttributeByCSS(testData, css_selector, attribute, variableName):
    ...
    try:
        ...
        logger.error(str(e))
        actionsOnFail.performActions(testData)
        testData[variableName] = "There was an ERROR trying to store attribute '%s' from css_selector '%s' here" % (
        attribute, css_selector)
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_css_selector(css_selector).get_attribute(attribute)
        logger.data("Attribute '%s' (found at css_selector '%s') = '%s' (stored as '%s' in testData)" % (
        attribute, css_selector, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
        logger.failed("Element (css_selector: '%s') was found, but attribute '%s' could not be stored" % (
...
def storeAttributeByID(testData, elementID, attribute, variableName):
    ...
    try:
        ...
        logger.error(str(e))
        actionsOnFail.performActions(testData)
        testData[variableName] = "There was an ERROR trying to store attribute '%s' from elementID '%s' here" % (
        attribute, elementID)
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_id(elementID).get_attribute(attribute)
        logger.data("Attribute '%s' (found at elementID '%s') = '%s' (stored as '%s' in testData)" % (
        attribute, elementID, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
        logger.failed(
            "Element (elementID: '%s') was found, but attribute '%s' could not be stored" % (elementID, attribute))
        testData[variableName] = "There was an ERROR trying to store attribute '%s' from elementID '%s' here" % (
        attribute, elementID)
        actionsOnFail.performActions(testData)
        return "FAILED"
...
def storeAttributeByName(testData, name, attribute, variableName):
    ...
    try:
        ...
        logger.error(str(e))
        actionsOnFail.performActions(testData)
        testData[variableName] = "There was an ERROR trying to store attribute '%s' from name '%s' here" % (
        attribute, name)
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_name(name).get_attribute(attribute)
        logger.data("Attribute '%s' (found at name '%s') = '%s' (stored as '%s' in testData)" % (
        attribute, name, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeAttributeByLink(testData, link, attribute, variableName):
    ...
    try:
        ...
        logger.error(str(e))
        actionsOnFail.performActions(testData)
        testData[variableName] = "There was an ERROR trying to store attribute '%s' from link '%s' here" % (
        attribute, link)
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_link_text(link).get_attribute(attribute)
        logger.data("Attribute '%s' (found at link '%s') = '%s' (stored as '%s' in testData)" % (
        attribute, link, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeSelectedByXPath(testData, xpath, variableName):
    ...
    try:
        ...
        logger.data(
            "'Selected status' for xpath '%s' = '%s' (stored as '%s')" % (xpath, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeSelectedByCSS(testData, css_selector, variableName):
    ...
    try:
        ...
        actionsOnFail.performActions(testData)
        testData[
            variableName] = "There was an ERROR trying to store 'selected status' for css_selector '%s' here" % css_selector
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_css_selector(css_selector).is_selected()
        logger.data("'Selected status' for css_selector '%s' = '%s' (stored as '%s')" % (
        css_selector, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
        logger.failed(
            "Element (css_selector: '%s') was found, but 'selected status' could not be stored" % css_selector)
        testData[
            variableName] = "There was an ERROR trying to store 'selected status' for css_selector '%s' here" % css_selector
        actionsOnFail.performActions(testData)
        return "FAILED"
...
def storeSelectedByID(testData, elementID, variableName):
    ...
    try:
        ...
        actionsOnFail.performActions(testData)
        testData[
            variableName] = "There was an ERROR trying to store 'selected status' for elementID '%s' here" % elementID
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_id(elementID).is_selected()
        logger.data("'Selected status' for elementID '%s' = '%s' (stored as '%s')" % (
        elementID, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeSelectedByName(testData, name, variableName):
    ...
    try:
        ...
        logger.data(
            "'Selected status' for name '%s' = '%s' (stored as '%s')" % (name, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeTextByXPath(testData, xpath, variableName):
    ...
    try:
        ...
        testData[variableName] = "There was an ERROR trying to 'store text' from xpath '%s' here, error: %s" % (
        xpath, str(e))
        actionsOnFail.performActions(testData)
        return "FAILED"
...
def storeTextByCSS(testData, css_selector, variableName):
    ...
    try:
        ...
        logger.failed(
            "Element (css_selector: '%s') was found, but text could not be stored, error: %s" % (css_selector, str(e)))
        testData[variableName] = "There was an ERROR trying to 'store text' from css_selector '%s' here" % css_selector
        actionsOnFail.performActions(testData)
        return "FAILED"
...
def storeTextByID(testData, elementID, variableName):
    ...
    try:
        ...
        logger.failed(
            "Element (elementID: '%s') was found, but text could not be stored, error: %s" % (elementID, str(e)))
        testData[variableName] = "There was an ERROR trying to 'store text' from elementID '%s' here" % elementID
        actionsOnFail.performActions(testData)
        return "FAILED"
...
def storeVisibleByXPath(testData, xpath, variableName):
    ...
    try:
        ...
        logger.data(
            "'Visible status' for xpath '%s' = '%s' (stored as '%s')" % (xpath, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeVisibleByCSS(testData, css_selector, variableName):
    ...
    try:
        ...
        actionsOnFail.performActions(testData)
        testData[
            variableName] = "There was an ERROR trying to store 'visible status' for css_selector '%s' here" % css_selector
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_css_selector(css_selector).is_displayed()
        logger.data("'Visible status' for css_selector '%s' = '%s' (stored as '%s')" % (
        css_selector, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeVisibleByID(testData, elementID, variableName):
    ...
    try:
        ...
        actionsOnFail.performActions(testData)
        testData[
            variableName] = "There was an ERROR trying to store 'visible status' for elementID '%s' here" % elementID
        return "FAILED"
    try:
        testData[variableName] = driver.find_element_by_id(elementID).is_displayed()
        logger.data("'Visible status' for elementID '%s' = '%s' (stored as '%s')" % (
        elementID, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeVisibleByName(testData, name, variableName):
    ...
    try:
        ...
        logger.data(
            "'Visible status' for name '%s' = '%s' (stored as '%s')" % (name, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
...
def storeXPathCount(testData, xpath, variableName):
    ...
    try:
        ...
        logger.data(
            "'xpath count' for xpath '%s' = '%s' (stored as '%s')" % (xpath, testData[variableName], variableName))
        return "PASSED"
    except:
...
def storeCSSCount(testData, css_selector, variableName):
    ...
    try:
        ...
        logger.data("'css count' for css_selector '%s' = '%s' (stored as '%s')" % (
        css_selector, testData[variableName], variableName))
        return "PASSED"
    except Exception as e:
        ...
        testData[
            variableName] = "This variable could not be set (should have been a css count using '%s')" % css_selector
        actionsOnFail.performActions(testData)
        return "FAILED"
...
def verifyAttributeByXPath(testData, xpath, attribute, value):
    ...
    try:
        ...
        if value == actual:
            ...
            logger.failed("Value '%s' was not found in xpath '%s', attribute '%s' ('%s' was found instead)" % (
            value, xpath, attribute, actual))
            actionsOnFail.performActions(testData)
            return "FAILED"
    except Exception as e:
        logger.error(str(e))
...
def verifyAttributeByCSS(testData, css_selector, attribute, value):
    ...
    try:
        ...
        if value == actual:
            ...
            logger.failed("Value '%s' was not found in css_selector '%s', attribute '%s' ('%s' was found instead)" % (
            value, css_selector, attribute, actual))
            actionsOnFail.performActions(testData)
            return "FAILED"
    except Exception as e:
        logger.error(str(e))
...
def verifyNotAttributeByCSS(testData, css_selector, attribute, value):
    ...
    try:
        if value != driver.find_element_by_css_selector(css_selector).get_attribute(attribute):
            logger.passed(
                "Value '%s' was not found in css_selector '%s', attribute '%s'" % (value, css_selector, attribute))
            return "PASSED"
        else:
            logger.failed(
                "Value '%s' was found in css_selector '%s', attribute '%s'" % (value, css_selector, attribute))
...
def verifyAttributeByID(testData, elementID, attribute, value):
    ...
    try:
        ...
        if value == actual:
            ...
            logger.failed("Value '%s' was not found in elementID '%s', attribute '%s' ('%s' was found instead)" % (
            value, elementID, attribute, actual))
            actionsOnFail.performActions(testData)
            return "FAILED"
    except Exception as e:
        logger.error(str(e))
...
def verifyNotEditableByID(testData, elementID):
    ...
    try:
        ...
        if driver.find_element_by_id(elementID).text == text:
            ...
            logger.passed(
                "Text '%s'  was not able to be entered into element '%s' - confirmed NOT editable" % (text, elementID))
            return "PASSED"
    except Exception as e:
...
def verifyNotEditableByXPath(testData, xpath):
    ...
    try:
        ...
        if driver.find_element_by_xpath(xpath).text == text:
            ...
            logger.passed(
                "Text '%s'  was not able to be entered into element '%s' - confirmed NOT editable" % (text, xpath))
            return "PASSED"
    except Exception as e:
        if "Element is disabled and so may not be used for actions" in str(e):
            logger.passed(
...
def verifyNotEditableByCSS(testData, css_selector):
    ...
    try:
        ...
        if driver.find_element_by_css_selector(css_selector).text == text:
            ...
            logger.passed("Text '%s' was not able to be entered into element '%s' - confirmed NOT editable" % (
            text, css_selector))
            return "PASSED"
    except Exception as e:
        if "Element is disabled and so may not be used for actions" in str(e):
...
def verifyNotEditableByName(testData, name):
    ...
    try:
        ...
        if driver.find_element_by_name(name).text == text:
            ...
            logger.passed(
                "Text '%s' was not able to be entered into element '%s' - confirmed NOT editable" % (text, name))
            return "PASSED"
    except Exception as e:
        if "Element is disabled and so may not be used for actions" in str(e):
            logger.passed(
...
def assertAttributeByCSS(testData, css_selector, attribute, value):
    ...
    try:
        if value == driver.find_element_by_css_selector(css_selector).get_attribute(attribute):
            logger.passed(
                "Attribute '%s' was found in css_selector '%s', attribute '%s'" % (value, css_selector, attribute))
            return "PASSED"
        else:
            logger.failed("[ASSERTION] Attribute '%s' was not found in css_selector '%s', attribute '%s'" % (
            value, css_selector, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertNotAttributeByCSS(testData, css_selector, attribute, value):
    ...
    try:
        if value != driver.find_element_by_css_selector(css_selector).get_attribute(attribute):
            logger.passed(
                "Attribute '%s' was not found in css_selector '%s', attribute '%s'" % (value, css_selector, attribute))
            return "PASSED"
        else:
            logger.failed("[ASSERTION] Attribute '%s' was found in css_selector '%s', attribute '%s'" % (
            value, css_selector, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
...
def assertAttributeByLink(testData, link, attribute, value):
    ...
    try:
        ...
        if value == actualValue:
            ...
            logger.failed(
                "[ASSERTION] Attribute '%s' was not found in link '%s', attribute '%s', actual attribute was: '%s'" % (
                value, link, attribute, actualValue))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertNotAttributeByLink(testData, link, attribute, value):
    ...
    try:
        if value != driver.find_element_by_link_text(link).get_attribute(attribute):
            ...
            logger.failed(
                "[ASSERTION] Attribute '%s' was found in link '%s', attribute '%s'" % (value, link, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertAttributeByXPath(testData, xpath, attr
e):
    driver = testData['driver']
    logger = testData['logger']
    try:
        if value == driver.find_element_by_xpath(xpath).get_attribute(attribute):
            ...
            logger.failed(
                "[ASSERTION] Attribute '%s' was not found in xpath '%s', attribute '%s'" % (value, xpath, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertNotAttributeByXPath(testData, xpath, attribute, value):
    ...
    try:
        if value != driver.find_element_by_xpath(xpath).get_attribute(attribute):
            ...
            logger.failed(
                "[ASSERTION] Attribute '%s' was found in xpath '%s', attribute '%s'" % (value, xpath, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertAttributeByID(testData, elementID, attribute, value):
    ...
    try:
        if value == driver.find_element_by_id(elementID).get_attribute(attribute):
            ...
            logger.failed("[ASSERTION] Attribute '%s' was not found in elementID '%s', attribute '%s'" % (
            value, elementID, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertNotAttributeByID(testData, elementID, attribute, value):
    ...
    try:
        if value != driver.find_element_by_id(elementID).get_attribute(attribute):
            logger.passed(
                "Attribute '%s' was not found in elementID '%s', attribute '%s'" % (value, elementID, attribute))
            return "PASSED"
        else:
            logger.failed("[ASSERTION] Attribute '%s' was found in elementID '%s', attribute '%s'" % (
            value, elementID, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
...
def assertAttributeByName(testData, name, attribute, value):
    ...
    try:
        if value == driver.find_element_by_name(name).get_attribute(attribute):
            ...
            logger.failed(
                "[ASSERTION] Attribute '%s' was not found in name '%s', attribute '%s'" % (value, name, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertNotAttributeByName(testData, name, attribute, value):
    ...
    try:
        if value != driver.find_element_by_name(name).get_attribute(attribute):
            ...
            logger.failed(
                "[ASSERTION] Attribute '%s' was found in name '%s', attribute '%s'" % (value, name, attribute))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertLocation(testData, location):
    ...
    try:
        if location in driver.current_url:
            ...
            logger.failed(
                "[ASSERTION] Current location ('%s') was not what was expected ('%s')" % (driver.current_url, location))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
...
def assertNotLocation(testData, location):
    ...
    try:
        if location != driver.current_url:
            ...
            logger.failed("[ASSERTION] Current location ('%s') was not what was expected, it matches '%s'" % (
            driver.current_url, location))
            actionsOnFail.exitTestScriptGracefully(testData)
    except Exception as e:
        logger.error(str(e))
        actionsOnFail.exitTestScriptGracefully(testData)
